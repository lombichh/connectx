...
public class CXBoardCopy {
	...
	public void copyFromCXBoard(CXBoard B) {
		for (CXCell cell : B.getMarkedCells()) {
			this.markColumn(cell.j);
		}
	}
	...
	/**
	 * Returns a copy of the CXBoardCopy object
	 *
